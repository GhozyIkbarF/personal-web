        ...
        <React.Fragment>
            ...
            <div className='w-full mt-[100px] flex flex-col px-5 gap-4 sm:px-20 lg:px-40'>
                ...
                <div className="flex gap-2 sm:gap-4 mt-2 text-sm md:text-lg">
                    <Link href={dataProject.repository} className='border py-3 px-6 rounded-md border-gray-dark bg-gray2 hover:scale-105 hover:bg-opacity-10 hover:bg-white transition-all sm:px-8' target='_blank'>Repository</Link>
                    {dataProject.livePreview && <Link href={dataProject.livePreview} className='border py-3 px-6 rounded-md border-gray-dark bg-gray2 hover:scale-105 hover:bg-opacity-10 hover:bg-white transition-all sm:px-8' target='_blank'>Live Preview</Link>}
                </div>
            </div>
        </React.Fragment>
    )
